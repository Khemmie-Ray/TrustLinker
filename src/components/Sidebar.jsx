...
const Sidebar = () =>  {
  ...
  return (
    <div className='bg-white w-[20%] text-[rgb(15,22,15)] p-8 py-12 h-[100vh] hidden lg:flex md:flex flex-col'>
      ...
      <NavLink to="create-event" className="text-[18px] flex items-center py-4 mb-4 px-4" style={({isActive}) => isActive ? activeStyle : null } end><CgHomeAlt className="mr-4" />create-event</NavLink>
